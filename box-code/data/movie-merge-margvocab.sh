...
rootdir=$1
name_margs="${rootdir}unmerged-data/movie_marginal_prob.txt"
name_vocab="${rootdir}unmerged-data/movie_vocabulary.txt"

genre_margs="${rootdir}unmerged-data/genre_marginal_prob.txt"
genre_vocab="${rootdir}unmerged-data/genre_vocabulary.txt"
